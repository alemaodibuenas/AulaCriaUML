...
public final class EstoqueFakeDB {
    ...
    private static void adicionarCategoria(int id, String descricao, Date dataInsert){
        ...
        categoriaPojo.setCategoriaID(id);
    ...
    private static void adicionarProduto(int id, int subcatid, int catid, String descricao, Date dataInsert){
        ...
        produtoPojo.setSubCategoriaID(subcatid);
        produtoPojo.setCategoriaID(catid);
        produtoPojo.setDescricao(descricao);
        produtoPojo.setDataInsert(dataInsert);
        produtos.add(produtoPojo);  
    }    
}
